    ...
    <div className="pl-[54px] group relative">
      ...
      {isEditing && !preview ? (
        <TextareaAutosize
          ...
          className="text-5xl bg-transparent font-bold break-words outline-none text-[#3f3f3fx] dark:text-[#cfcfcf] resize"
        />
      ) : (
        <div
          onClick={enableInput}
          className="pb-[11.5px] text-5xl font-bold break-words outline-none text-[#3f3f3fx] dark:text-[#cfcfcf]"
        >
          {initialData.title}
        </div>
      )}
